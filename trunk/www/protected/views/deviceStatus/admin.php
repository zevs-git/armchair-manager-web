...
$this->widget('zii.widgets.grid.CGridView', array(
    ...
    'columns' => array(
        ...
        array('name' => 'deviceCashReport.coint_cash',
            ...
            'type' => 'raw',
            'value' => '($data->deviceCashReport->count_cash)?"<b style=\'color: green\' rel=\'tooltip\' title=\'Последняя купюра\'>" . $data->deviceCashReport->last_cash . "</b>&nbsp;&nbsp;<div style=\'float:right;\' rel=\'tooltip\' title=\'Наполнение купюрника\'>" .$data->deviceCashReport->count_cash . "/" . "400</div>":"-" '),
        ...
        array('name' => 'deviceCashReport.coint_coin',
            ...
            'htmlOptions' => array('style' => 'align: center; width: 120px;'),
            'type' => 'raw',
            'value' => '($data->deviceCashReport->count_coin)?"<b style=\'color: green\' rel=\'tooltip\' title=\'Последняя купюра\'>" . $data->deviceCashReport->last_coin . "</b>&nbsp;&nbsp;<div style=\'float:right;\' rel=\'tooltip\' title=\'Наполнение купюрника\'>" .$data->deviceCashReport->count_coin . "/" . "400</div>":"-" '),
